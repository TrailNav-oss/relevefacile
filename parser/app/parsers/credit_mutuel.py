...
class CreditMutuelParser(BankParser):
    """Parser for Crédit Mutuel bank statements."""
    ...
    detection_patterns = [
        r"CREDIT\s*MUTUEL",
        r"www\.creditmutuel",
        r"CAISSE\s+DE\s+CREDIT\s+MUTUEL",
    ]
...
class CICParser(CreditMutuelParser):
    """Parser for CIC bank statements (shared IT with Crédit Mutuel)."""
